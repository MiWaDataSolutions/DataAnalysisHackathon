...
namespace DataAnalystBackend.Shared.Interfaces.Services
{
    public interface IDataSessionService
    {
        ...
        Task StartGeneration<TModel>(string fileName, Guid dataSessionId, string userId, Func<TModel, BasicDeliverEventArgs, Task> consumeMethod, bool initialFileHasHeaders);
    }
}
